...
# arg
  ...
  z
# tools
  colored-man-pages # oh-my-zsh
  rand-quote
  safe-paste # oh-my-zsh
  history
...
alias rreadelf='riscv64-unknown-elf-readelf'
...
# export GOPATH=~/Desktop/goWork
#export GOPATH=~/go
#export GOBIN=$GOPATH/bin
#export PATH=$PATH:$GOBIN
#export PATH=$PATH:~/WangZhen/Packages/fabric-ca/bin
...
# k210
# export PATH=$PATH:/opt/kendryte-openocd/bin/
# export PATH=$PATH:/opt/kendryte-toolchain/bin/

function proxy_on() {
    export http_proxy="https://wangzhen0518:wz20020518@202.38.95.22:3128/"
