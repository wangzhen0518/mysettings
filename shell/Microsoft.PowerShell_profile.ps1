...
Set-Alias -Name bash -Value D:\Developer\Scoop\shims\bash.exe
...
function Active-Conda {
	(& "D:\Developer\Scoop\apps\miniconda3\current\Scripts\conda.exe" "shell.powershell" "hook") | Out-String | Invoke-Expression
	. $Profile
}
...
Set MIRA "zwang@202.38.69.241:~/Downloads"
